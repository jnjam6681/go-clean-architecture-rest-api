...
func (r todoRepository) Update(ctx context.Context, todo *model.Todo, id int32) (*model.Todo, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "todoRepository.Create")
	defer span.Finish()
...
func (r todoRepository) GetByID(ctx context.Context, id int32) (*model.Todo, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "todoRepository.Create")
	defer span.Finish()
